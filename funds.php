...
$query = "SELECT event_name, funds_allocated FROM events WHERE id = ?";
...
$expense_query = "SELECT * FROM event_expenses WHERE event_id = ?";
...
<body class="container mt-5">
    ...
    <a href="edashboard.php" class="btn btn-warning mt-3">Back to Dashboard</a>
</body>
</html>
