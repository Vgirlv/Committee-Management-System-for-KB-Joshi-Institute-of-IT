...
if (isset($_GET['id'])) {
    ...
    $query1 = "SELECT event_name, event_date, description, membersroles, venue, funds_allocated, spent_amount FROM eventsss WHERE id = ?";
    ...
    $query2 = "SELECT guests, sponsors, schedule, agenda_path, image_path FROM event_reportsss WHERE event_id = ?";
