...
<a href="edashboard.php" class="btn btn-warning">Back to Dashboard</a>
<a href="download_report.php?id=<?php echo $event['id']; ?>" class="btn btn-success">Download Report</a>
