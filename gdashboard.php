...
$query = "SELECT name FROM usersss WHERE id='$user_id'";
...
$events_query = "SELECT * FROM eventsss ORDER BY event_date DESC";
$events_result = mysqli_query($conn, $events_query);


$past_query = "SELECT * FROM eventsss WHERE event_date < NOW() ORDER BY event_date DESC";
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-success fixed-top">
        <div class="container-fluid">
            <strong class="navbar-brand">Green Club Committee</strong>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto bg-light">
                <li class="nav-item"><a class="nav-link" href="gdashboard.php">Events</a></li>
                <li class="nav-item"><a class="nav-link" href="memberrr.php">Members</a></li>
                    <li class="nav-item"><a class="nav-link" href="collaboraters.php">Collaborations</a></li>
                    <li class="nav-item"><a class="nav-link" href="green_initiatives.php">Initiatives</a></li>
                    <li class="nav-item"><a class="nav-link" href="galleryg.php">Gallery</a></li>
                    <li class="nav-item"><a class="nav-link text-danger" href="logouttt.php">Logout</a></li>
    ...
    <div class="content-wrapper">
        <div class="sidebar">
            <div class="profile-pic bg-white">
                <img id="profileImage" src="planet-earth.png" alt=" ">
                <input type="file" id="fileInput" accept="image/*" />
            </div>

            <h4 class="text-center">Environment Cell KBJIIT</h4>
            <strong class="text-center">Committee Head Name:</strong>
            <p>Vaishali Harsulkar<br>Vidya Dole</p>

            <strong>Objectives:</strong>
            <ul>
                <li>To motivate the students to keep their surroundings green and clean
                </li>
                <li>Promote Green Awareness</li>
            </ul>
        </div>
    </div>
            ...
            <div class="list-group">
                <?php while ($event = mysqli_fetch_assoc($events_result)) : ?>
                    <div class="list-group-item">
                        ...
                        <div>
        <!-- Funds Button -->
        <a href="fundsss.php?event_id=<?php echo $event['id']; ?>" class="btn btn-warning mt-2">Fund Details</a>

        <!-- Delete Button -->
        <a href="delete_eventtt.php?event_id=<?php echo $event['id']; ?>" 
...
<h2 class="mt-5">Past Events</h2>
    <div class="row">
        <?php 
        $past = mysqli_query($conn, "SELECT * FROM eventsss WHERE event_date < NOW() ORDER BY event_date DESC");
            ...
            <div class="col-md-4 col-sm-6 mb-4">
                <div class="card bg-light">
                    <div class="card-body">
                        ...
                        <a href="view_reportss.php?id=<?php echo $event['id']; ?>" class="btn btn-primary">Create Report</a>
                        <a href="view_final_reportss.php?id=<?php echo $event['id']; ?>" class="btn btn-success">View Report</a>
...
<!-- Bootstrap Modal for Agenda -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="create_eventtt.php" method="POST">
                        <div class="mb-3">
    ...
    <div class="footer">
        &copy; 2025 Green Committee Club. All rights reserved.
        <a href="https://maharshikarvebcapune.org/green-initiative/">Green-Initiative</a>
    </div>
