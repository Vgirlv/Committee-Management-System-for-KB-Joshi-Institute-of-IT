...
$query = "SELECT name FROM userss WHERE id='$user_id'";
...
$events_query = "SELECT * FROM eventss ORDER BY event_date DESC";
$events_result = mysqli_query($conn, $events_query);


$past_query = "SELECT * FROM eventss WHERE event_date < NOW() ORDER BY event_date DESC";
...
<head>
    ...
    <title>Cultural Club Dashboard</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-warning fixed-top">
        <div class="container-fluid">
            <strong class="navbar-brand">Cultural Committee Cell</strong>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto bg-light">
                    <li class="nav-item"><a class="nav-link" href="cdashboard.php">Events</a></li>
                    <li class="nav-item"><a class="nav-link" href="memberr.php">Members</a></li>
                    <li class="nav-item"><a class="nav-link" href="achievements.php">Achievements</a></li>
                    <li class="nav-item"><a class="nav-link" href="galleryc.php">Gallery</a></li>
                    <li class="nav-item"><a class="nav-link text-danger" href="logoutt.php">Logout</a></li>
    ...
    <div class="content-wrapper">
        <div class="sidebar">
            <div class="profile-pic bg-dark">
                <img id="profileImage" src="dance.png" alt=" ">
                <input type="file" id="fileInput" accept="image/*" />
            </div>

            <h4 class="text-center">Cultural Cell KBJIIT</h4>
            <strong class="text-center">Committee Head Name:</strong>
            <p>Rucha Panse <br>Pritee Patil</p>

            <strong>Objectives:</strong>
            <ul>
                <li>Encourage Talent & Creativity</li>
                <li>Conduct various cultural programmes in the college </li>
    ...
    <div class="container mt-3">
        ...
        <button class="btn btn-success me-3" data-bs-toggle="modal" data-bs-target="#createEventModal">
            Create Event</button>
        <input
        type="text"
        id="search-bar"
            ...
            <div class="list-group">
                <?php while ($event = mysqli_fetch_assoc($events_result)) : ?>
                    <div class="list-group-item">
                        ...
                        <div>
        <!-- Funds Button -->
        <a href="fundss.php?event_id=<?php echo $event['id']; ?>" class="btn btn-warning mt-2">Fund Details</a>

        <!-- Delete Button -->
        <a href="delete_eventt.php?event_id=<?php echo $event['id']; ?>" 
...
<h2 class="mt-5">Past Events</h2>
    <div class="row">
        <?php 
        $past = mysqli_query($conn, "SELECT * FROM eventss WHERE event_date < NOW() ORDER BY event_date DESC");
            ...
            <div class="col-md-4 col-sm-6 mb-4">
                <div class="card bg-light">
                    <div class="card-body">
                        ...
                        <a href="view_reports.php?id=<?php echo $event['id']; ?>" class="btn btn-primary">Create Report</a>
                        <a href="view_final_reports.php?id=<?php echo $event['id']; ?>" class="btn btn-success">View Report</a>
...
<!-- Bootstrap Modal for Agenda -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="create_eventt.php" method="POST">
                        <div class="mb-3">
    ...
    <div class="footer">
        &copy; 2025 Cultural Club. All rights reserved.
        | <a href="https://www.instagram.com/aavishkar.fest">Instagram</a>
    </div>
