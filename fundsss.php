...
$query = "SELECT event_name, funds_allocated FROM eventsss WHERE id = ?";
...
$expense_query = "SELECT * FROM event_expensesss WHERE event_id = ?";
...
<body class="container mt-5">
    ...
    <form action="add_expensess.php" method="POST">
        <input type="hidden" name="event_id" value="<?php echo $event_id; ?>">
    ...
    <a href="gdashboard.php" class="btn btn-warning mt-3">Back to Dashboard</a>
</body>
</html>
