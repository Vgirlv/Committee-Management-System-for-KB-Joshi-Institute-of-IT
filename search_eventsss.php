    ...
    if (mysqli_num_rows($result) > 0) {
        while ($event = mysqli_fetch_assoc($result)) {
            ...
            <div class='list-group-item'>
                ...
                <!-- Action Buttons -->
                <a href='fundsss.php?event_id=" . $event['id'] . "' class='btn btn-info mt-2'>Fund Details</a>
                <a href='view_final_reportss.php?id=" . $event['id'] . "' class='btn btn-success mt-2'>View Report</a>
